...
import { Plus, Edit, Trash2, Bell, Package, CreditCard, Users } from 'lucide-react'
...
const AdminPage = () => {
  ...
  const generateRandomNotification = () => {
    const orderNotifications = [
      'New order #ORD001 received - ₵150.00',
      'Order #ORD002 payment confirmed - ₵89.50',
      'New customer registration',
      'Order #ORD003 shipped successfully'
    ]
    
    const randomNotification: Notification = {
      id: Date.now().toString(),
      type: Math.random() > 0.5 ? 'order' : 'payment',
      message: orderNotifications[Math.floor(Math.random() * orderNotifications.length)],
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your store products, orders, and notifications</p>
        </div>
